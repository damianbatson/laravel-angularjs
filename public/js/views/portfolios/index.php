...
<body class="container" ng-app="myApp" ng-controller="projectsCtrl">

	<div class="col-md-4">
		<h2>PortfoliosAJS</h2>

		<form ng-submit="submitComment()" enctype="multipart/form-data"> <!-- ng-submit will disable the default form action and use our function -->
		...
		<!-- COMMENT TEXT -->
		<div class="form-group">
			<input type="text" class="form-control input-sm" name="comment" ng-model="projectData.description" placeholder="Say what you have to say">
		</div>

		<div class="form-group">
			<input type="file" class="form-control input-sm" name="comment" ng-model="projectData.image" placeholder="Say what you have to say">
		</div>
...
<div class="col-md-8">
	...
	<div class="comment" ng-hide="loading" ng-repeat="project in projects"> 
		...
		<img class"img-responsive" ng-src="{{project.image}} ">
		<p>{{ project.user_id}}</p>
